...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	6fa78793          	addi	a5,a5,1786 # 7708 <malloc+0x258a>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	21a50513          	addi	a0,a0,538 # 5280 <malloc+0x102>
      6e:	05c050ef          	jal	50ca <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	20050513          	addi	a0,a0,512 # 52a0 <malloc+0x122>
      a8:	022050ef          	jal	50ca <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	1f850513          	addi	a0,a0,504 # 52b8 <malloc+0x13a>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	20250513          	addi	a0,a0,514 # 52d8 <malloc+0x15a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	1ce50513          	addi	a0,a0,462 # 52c0 <malloc+0x142>
      fa:	7d1040ef          	jal	50ca <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	1e250513          	addi	a0,a0,482 # 52e8 <malloc+0x16a>
     10e:	7bd040ef          	jal	50ca <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	19450513          	addi	a0,a0,404 # 5310 <malloc+0x192>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	18a50513          	addi	a0,a0,394 # 5330 <malloc+0x1b2>
     1ae:	71d040ef          	jal	50ca <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	11450513          	addi	a0,a0,276 # 5358 <malloc+0x1da>
     24c:	28b040ef          	jal	4cd6 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	104a8a93          	addi	s5,s5,260 # 5358 <malloc+0x1da>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	0a650513          	addi	a0,a0,166 # 5368 <malloc+0x1ea>
     2ca:	601040ef          	jal	50ca <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	0ac50513          	addi	a0,a0,172 # 5388 <malloc+0x20a>
     2e4:	5e7040ef          	jal	50ca <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	0a250513          	addi	a0,a0,162 # 53a0 <malloc+0x222>
     306:	1d1040ef          	jal	4cd6 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	09298993          	addi	s3,s3,146 # 53a0 <malloc+0x222>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	05650513          	addi	a0,a0,86 # 53a0 <malloc+0x222>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	fca58593          	addi	a1,a1,-54 # 5328 <malloc+0x1aa>
     366:	141040ef          	jal	4ca6 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	05050513          	addi	a0,a0,80 # 53c0 <malloc+0x242>
     378:	553040ef          	jal	50ca <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	109040ef          	jal	4c86 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	02650513          	addi	a0,a0,38 # 53a8 <malloc+0x22a>
     38a:	541040ef          	jal	50ca <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	0f7040ef          	jal	4c86 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	01450513          	addi	a0,a0,20 # 53a8 <malloc+0x22a>
     39c:	52f040ef          	jal	50ca <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	ff450513          	addi	a0,a0,-12 # 53a0 <malloc+0x222>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	27878793          	addi	a5,a5,632 # 7708 <malloc+0x258a>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	f12a0a13          	addi	s4,s4,-238 # 53d0 <malloc+0x252>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	e9450513          	addi	a0,a0,-364 # 53d8 <malloc+0x25a>
     54c:	37f040ef          	jal	50ca <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	e9650513          	addi	a0,a0,-362 # 53f0 <malloc+0x272>
     562:	369040ef          	jal	50ca <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	eb050513          	addi	a0,a0,-336 # 5420 <malloc+0x2a2>
     578:	353040ef          	jal	50ca <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	708040ef          	jal	4c86 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	ece50513          	addi	a0,a0,-306 # 5450 <malloc+0x2d2>
     58a:	341040ef          	jal	50ca <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	ec850513          	addi	a0,a0,-312 # 5460 <malloc+0x2e2>
     5a0:	32b040ef          	jal	50ca <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	14a78793          	addi	a5,a5,330 # 7708 <malloc+0x258a>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	e9ea0a13          	addi	s4,s4,-354 # 5490 <malloc+0x312>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	d2ea8a93          	addi	s5,s5,-722 # 5328 <malloc+0x1aa>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	e1a50513          	addi	a0,a0,-486 # 5498 <malloc+0x31a>
     686:	245040ef          	jal	50ca <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	e1c50513          	addi	a0,a0,-484 # 54b0 <malloc+0x332>
     69c:	22f040ef          	jal	50ca <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	5e4040ef          	jal	4c86 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	daa50513          	addi	a0,a0,-598 # 5450 <malloc+0x2d2>
     6ae:	21d040ef          	jal	50ca <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	5d2040ef          	jal	4c86 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	e2850513          	addi	a0,a0,-472 # 54e0 <malloc+0x362>
     6c0:	20b040ef          	jal	50ca <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	e2a50513          	addi	a0,a0,-470 # 54f8 <malloc+0x37a>
     6d6:	1f5040ef          	jal	50ca <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	c1c50513          	addi	a0,a0,-996 # 5310 <malloc+0x192>
     6fc:	5da040ef          	jal	4cd6 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	c0c50513          	addi	a0,a0,-1012 # 5310 <malloc+0x192>
     70c:	5ba040ef          	jal	4cc6 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	c0c58593          	addi	a1,a1,-1012 # 5320 <malloc+0x1a2>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	be850513          	addi	a0,a0,-1048 # 5310 <malloc+0x192>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	bc450513          	addi	a0,a0,-1084 # 5310 <malloc+0x192>
     754:	572040ef          	jal	4cc6 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	bb450513          	addi	a0,a0,-1100 # 5310 <malloc+0x192>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	dfa58593          	addi	a1,a1,-518 # 5588 <malloc+0x40a>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	b4c50513          	addi	a0,a0,-1204 # 5310 <malloc+0x192>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	d3050513          	addi	a0,a0,-720 # 5528 <malloc+0x3aa>
     800:	0cb040ef          	jal	50ca <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	d3c50513          	addi	a0,a0,-708 # 5548 <malloc+0x3ca>
     814:	0b7040ef          	jal	50ca <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	d3c50513          	addi	a0,a0,-708 # 5558 <malloc+0x3da>
     824:	0a7040ef          	jal	50ca <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	d4850513          	addi	a0,a0,-696 # 5578 <malloc+0x3fa>
     838:	093040ef          	jal	50ca <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	d1850513          	addi	a0,a0,-744 # 5558 <malloc+0x3da>
     848:	083040ef          	jal	50ca <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	d3a50513          	addi	a0,a0,-710 # 5590 <malloc+0x412>
     85e:	06d040ef          	jal	50ca <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	d4450513          	addi	a0,a0,-700 # 55b0 <malloc+0x432>
     874:	057040ef          	jal	50ca <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	d3850513          	addi	a0,a0,-712 # 55d0 <malloc+0x452>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	d4c98993          	addi	s3,s3,-692 # 55f8 <malloc+0x47a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	d7ca8a93          	addi	s5,s5,-644 # 5630 <malloc+0x4b2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	ce250513          	addi	a0,a0,-798 # 55d0 <malloc+0x452>
  ...
  if(unlink("small") < 0){
     ...
     922:	cb250513          	addi	a0,a0,-846 # 55d0 <malloc+0x452>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	c9450513          	addi	a0,a0,-876 # 55d8 <malloc+0x45a>
     94c:	77e040ef          	jal	50ca <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	cae50513          	addi	a0,a0,-850 # 5608 <malloc+0x48a>
     962:	768040ef          	jal	50ca <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	cd050513          	addi	a0,a0,-816 # 5640 <malloc+0x4c2>
     978:	752040ef          	jal	50ca <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	ce450513          	addi	a0,a0,-796 # 5668 <malloc+0x4ea>
     98c:	73e040ef          	jal	50ca <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	cf050513          	addi	a0,a0,-784 # 5688 <malloc+0x50a>
     9a0:	72a040ef          	jal	50ca <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	cf450513          	addi	a0,a0,-780 # 56a0 <malloc+0x522>
     9b4:	716040ef          	jal	50ca <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	cea50513          	addi	a0,a0,-790 # 56c0 <malloc+0x542>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	ca450513          	addi	a0,a0,-860 # 56c0 <malloc+0x542>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	c6c50513          	addi	a0,a0,-916 # 56c8 <malloc+0x54a>
     a64:	666040ef          	jal	50ca <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	c7650513          	addi	a0,a0,-906 # 56e8 <malloc+0x56a>
     a7a:	650040ef          	jal	50ca <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	c8a50513          	addi	a0,a0,-886 # 5710 <malloc+0x592>
     a8e:	63c040ef          	jal	50ca <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	c1a50513          	addi	a0,a0,-998 # 56c0 <malloc+0x542>
     ...
     ad0:	c6450513          	addi	a0,a0,-924 # 5730 <malloc+0x5b2>
     ad4:	5f6040ef          	jal	50ca <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	c7650513          	addi	a0,a0,-906 # 5758 <malloc+0x5da>
     aea:	5e0040ef          	jal	50ca <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	c7850513          	addi	a0,a0,-904 # 5770 <malloc+0x5f2>
     b00:	5ca040ef          	jal	50ca <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	c8c50513          	addi	a0,a0,-884 # 5798 <malloc+0x61a>
     b14:	5b6040ef          	jal	50ca <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	c7e50513          	addi	a0,a0,-898 # 57b0 <malloc+0x632>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	c9a58593          	addi	a1,a1,-870 # 57e0 <malloc+0x662>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	c5650513          	addi	a0,a0,-938 # 57b0 <malloc+0x632>
  ...
  unlink("unlinkread");
     ...
     be6:	bce50513          	addi	a0,a0,-1074 # 57b0 <malloc+0x632>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	bc250513          	addi	a0,a0,-1086 # 57c0 <malloc+0x642>
     c06:	4c4040ef          	jal	50ca <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	bd650513          	addi	a0,a0,-1066 # 57e8 <malloc+0x66a>
     c1a:	4b0040ef          	jal	50ca <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	be250513          	addi	a0,a0,-1054 # 5808 <malloc+0x68a>
     c2e:	49c040ef          	jal	50ca <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	bf650513          	addi	a0,a0,-1034 # 5830 <malloc+0x6b2>
     c42:	488040ef          	jal	50ca <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	c0250513          	addi	a0,a0,-1022 # 5850 <malloc+0x6d2>
     c56:	474040ef          	jal	50ca <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	c0e50513          	addi	a0,a0,-1010 # 5870 <malloc+0x6f2>
     c6a:	460040ef          	jal	50ca <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	c0e50513          	addi	a0,a0,-1010 # 5890 <malloc+0x712>
     c8a:	04c040ef          	jal	4cd6 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	c0a50513          	addi	a0,a0,-1014 # 5898 <malloc+0x71a>
     c96:	040040ef          	jal	4cd6 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	bf250513          	addi	a0,a0,-1038 # 5890 <malloc+0x712>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	b2e58593          	addi	a1,a1,-1234 # 57e0 <malloc+0x662>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	b1650513          	addi	a0,a0,-1258 # 58a0 <malloc+0x722>
     d92:	338040ef          	jal	50ca <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	b1a50513          	addi	a0,a0,-1254 # 58b8 <malloc+0x73a>
     da6:	324040ef          	jal	50ca <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	b1e50513          	addi	a0,a0,-1250 # 58d0 <malloc+0x752>
     dba:	310040ef          	jal	50ca <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	b2a50513          	addi	a0,a0,-1238 # 58f0 <malloc+0x772>
     dce:	2fc040ef          	jal	50ca <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	b4650513          	addi	a0,a0,-1210 # 5920 <malloc+0x7a2>
     de2:	2e8040ef          	jal	50ca <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	b4a50513          	addi	a0,a0,-1206 # 5938 <malloc+0x7ba>
     df6:	2d4040ef          	jal	50ca <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	b4e50513          	addi	a0,a0,-1202 # 5950 <malloc+0x7d2>
     e0a:	2c0040ef          	jal	50ca <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	b6250513          	addi	a0,a0,-1182 # 5978 <malloc+0x7fa>
     e1e:	2ac040ef          	jal	50ca <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	b7e50513          	addi	a0,a0,-1154 # 59a8 <malloc+0x82a>
     e32:	298040ef          	jal	50ca <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	b7498993          	addi	s3,s3,-1164 # 59c8 <malloc+0x84a>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	b4c50513          	addi	a0,a0,-1204 # 59d8 <malloc+0x85a>
     e94:	236040ef          	jal	50ca <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	b4450513          	addi	a0,a0,-1212 # 59f8 <malloc+0x87a>
     ebc:	61b030ef          	jal	4cd6 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	b3450513          	addi	a0,a0,-1228 # 59f8 <malloc+0x87a>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	b1aa0a13          	addi	s4,s4,-1254 # 59f8 <malloc+0x87a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	acc50513          	addi	a0,a0,-1332 # 59f8 <malloc+0x87a>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	a6c50513          	addi	a0,a0,-1428 # 5a00 <malloc+0x882>
     f9c:	12e040ef          	jal	50ca <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	a7250513          	addi	a0,a0,-1422 # 5a20 <malloc+0x8a2>
     fb6:	114040ef          	jal	50ca <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	a8650513          	addi	a0,a0,-1402 # 5a48 <malloc+0x8ca>
     fca:	100040ef          	jal	50ca <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	29e98993          	addi	s3,s3,670 # 52b8 <malloc+0x13a>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	b0878793          	addi	a5,a5,-1272 # 6b98 <malloc+0x1a1a>
  ...
  if(pid == 0){
    ...
    10e8:	62478793          	addi	a5,a5,1572 # 7708 <malloc+0x258a>
    ...
    110c:	1b050513          	addi	a0,a0,432 # 52b8 <malloc+0x13a>
    ...
    1120:	9d450513          	addi	a0,a0,-1580 # 5af0 <malloc+0x972>
    1124:	7a7030ef          	jal	50ca <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	93450513          	addi	a0,a0,-1740 # 5a68 <malloc+0x8ea>
    113c:	78f030ef          	jal	50ca <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	93c50513          	addi	a0,a0,-1732 # 5a88 <malloc+0x90a>
    1154:	777030ef          	jal	50ca <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	94250513          	addi	a0,a0,-1726 # 5aa8 <malloc+0x92a>
    116e:	75d030ef          	jal	50ca <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	95250513          	addi	a0,a0,-1710 # 5ad0 <malloc+0x952>
    1186:	745030ef          	jal	50ca <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	2fb030ef          	jal	4c86 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	f6050513          	addi	a0,a0,-160 # 70f0 <malloc+0x1f72>
    1198:	733030ef          	jal	50ca <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	94e50513          	addi	a0,a0,-1714 # 5b18 <malloc+0x99a>
    11d2:	6f9030ef          	jal	50ca <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	12450513          	addi	a0,a0,292 # 5310 <malloc+0x192>
  ...
  if(pid == 0){
    ...
    1216:	0fea0a13          	addi	s4,s4,254 # 5310 <malloc+0x192>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	95ea8a93          	addi	s5,s5,-1698 # 5b78 <malloc+0x9fa>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	8d250513          	addi	a0,a0,-1838 # 5b48 <malloc+0x9ca>
    127e:	64d030ef          	jal	50ca <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	8d650513          	addi	a0,a0,-1834 # 5b60 <malloc+0x9e2>
    1292:	639030ef          	jal	50ca <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	8e850513          	addi	a0,a0,-1816 # 5b88 <malloc+0xa0a>
    12a8:	623030ef          	jal	50ca <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	052a0a13          	addi	s4,s4,82 # 5310 <malloc+0x192>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	8e2a8a93          	addi	s5,s5,-1822 # 5ba8 <malloc+0xa2a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	01050513          	addi	a0,a0,16 # 5310 <malloc+0x192>
  ...
  exit(xstatus);
    ...
    131a:	84a50513          	addi	a0,a0,-1974 # 5b60 <malloc+0x9e2>
    131e:	5ad030ef          	jal	50ca <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	88450513          	addi	a0,a0,-1916 # 5bb0 <malloc+0xa32>
    1334:	597030ef          	jal	50ca <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	f6e78793          	addi	a5,a5,-146 # 52b8 <malloc+0x13a>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	87a78793          	addi	a5,a5,-1926 # 5bd0 <malloc+0xa52>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	87250513          	addi	a0,a0,-1934 # 5bd8 <malloc+0xa5a>
  ...
  if(pid == 0) {
    ...
    138e:	84e50513          	addi	a0,a0,-1970 # 5bd8 <malloc+0xa5a>
    ...
    13a6:	85650513          	addi	a0,a0,-1962 # 5bf8 <malloc+0xa7a>
    13aa:	521030ef          	jal	50ca <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	79050513          	addi	a0,a0,1936 # 5b48 <malloc+0x9ca>
    13c0:	50b030ef          	jal	50ca <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	81450513          	addi	a0,a0,-2028 # 5be0 <malloc+0xa62>
    13d4:	4f7030ef          	jal	50ca <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	ed650513          	addi	a0,a0,-298 # 52b8 <malloc+0x13a>
  ...
  if(xstatus != 0)
    ...
    140e:	7fe50513          	addi	a0,a0,2046 # 5c08 <malloc+0xa8a>
    1412:	4b9030ef          	jal	50ca <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	80250513          	addi	a0,a0,-2046 # 5c20 <malloc+0xaa2>
    1426:	4a5030ef          	jal	50ca <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	7aa50513          	addi	a0,a0,1962 # 5bd8 <malloc+0xa5a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	23850513          	addi	a0,a0,568 # 5688 <malloc+0x50a>
    1458:	473030ef          	jal	50ca <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	6fc50513          	addi	a0,a0,1788 # 5b60 <malloc+0x9e2>
    146c:	45f030ef          	jal	50ca <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	015030ef          	jal	4c86 <exit>
  unlink("echo-ok");
    1476:	00004517          	auipc	a0,0x4
    147a:	76250513          	addi	a0,a0,1890 # 5bd8 <malloc+0xa5a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	79c50513          	addi	a0,a0,1948 # 5c38 <malloc+0xaba>
    14a4:	427030ef          	jal	50ca <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	70850513          	addi	a0,a0,1800 # 5c50 <malloc+0xad2>
    1550:	37b030ef          	jal	50ca <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	6a650513          	addi	a0,a0,1702 # 5c68 <malloc+0xaea>
    15ca:	301030ef          	jal	50ca <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	6aa50513          	addi	a0,a0,1706 # 5c80 <malloc+0xb02>
    15de:	2ed030ef          	jal	50ca <printf>
          return;
    ...
    160a:	69250513          	addi	a0,a0,1682 # 5c98 <malloc+0xb1a>
    160e:	2bd030ef          	jal	50ca <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	67a50513          	addi	a0,a0,1658 # 5cb8 <malloc+0xb3a>
    1646:	285030ef          	jal	50ca <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	4a850513          	addi	a0,a0,1192 # 5b48 <malloc+0x9ca>
    16a8:	223030ef          	jal	50ca <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	61c50513          	addi	a0,a0,1564 # 5cd0 <malloc+0xb52>
    16bc:	20f030ef          	jal	50ca <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	62050513          	addi	a0,a0,1568 # 5ce8 <malloc+0xb6a>
    16d0:	1fb030ef          	jal	50ca <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	42450513          	addi	a0,a0,1060 # 5b48 <malloc+0x9ca>
    172c:	19f030ef          	jal	50ca <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	40c50513          	addi	a0,a0,1036 # 5b48 <malloc+0x9ca>
    1744:	187030ef          	jal	50ca <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	56e50513          	addi	a0,a0,1390 # 5d08 <malloc+0xb8a>
    17a2:	129030ef          	jal	50ca <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	4de030ef          	jal	4c86 <exit>
{
    ...
    17da:	54250513          	addi	a0,a0,1346 # 5d18 <malloc+0xb9a>
    17de:	0ed030ef          	jal	50ca <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	8e050513          	addi	a0,a0,-1824 # 70f0 <malloc+0x1f72>
    1818:	0b3030ef          	jal	50ca <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	2b650513          	addi	a0,a0,694 # 5b48 <malloc+0x9ca>
    189a:	031030ef          	jal	50ca <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	32a50513          	addi	a0,a0,810 # 5be0 <malloc+0xa62>
    18be:	00d030ef          	jal	50ca <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	42450513          	addi	a0,a0,1060 # 5d38 <malloc+0xbba>
    191c:	7ae030ef          	jal	50ca <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	41850513          	addi	a0,a0,1048 # 5d50 <malloc+0xbd2>
    1940:	78a030ef          	jal	50ca <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	3ee50513          	addi	a0,a0,1006 # 5d78 <malloc+0xbfa>
    1992:	738030ef          	jal	50ca <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	90450513          	addi	a0,a0,-1788 # 5328 <malloc+0x1aa>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	8d0b0b13          	addi	s6,s6,-1840 # 5328 <malloc+0x1aa>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	340c0c13          	addi	s8,s8,832 # 5da0 <malloc+0xc22>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	0dc50513          	addi	a0,a0,220 # 5b48 <malloc+0x9ca>
    1a74:	656030ef          	jal	50ca <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	2e450513          	addi	a0,a0,740 # 5df0 <malloc+0xc72>
    1b14:	5b6030ef          	jal	50ca <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	28450513          	addi	a0,a0,644 # 5da8 <malloc+0xc2a>
    1b2c:	59e030ef          	jal	50ca <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	28850513          	addi	a0,a0,648 # 5dc0 <malloc+0xc42>
    1b40:	58a030ef          	jal	50ca <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	28c50513          	addi	a0,a0,652 # 5dd8 <malloc+0xc5a>
    1b54:	576030ef          	jal	50ca <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	f5e50513          	addi	a0,a0,-162 # 5b48 <malloc+0x9ca>
    1bf2:	4d8030ef          	jal	50ca <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	21450513          	addi	a0,a0,532 # 5e18 <malloc+0xc9a>
    1c0c:	4be030ef          	jal	50ca <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	ed650513          	addi	a0,a0,-298 # 5b48 <malloc+0x9ca>
    1c7a:	450030ef          	jal	50ca <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	1a250513          	addi	a0,a0,418 # 5e38 <malloc+0xcba>
    1c9e:	42c030ef          	jal	50ca <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	16a50513          	addi	a0,a0,362 # 5e50 <malloc+0xcd2>
    1cee:	3dc030ef          	jal	50ca <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	e4e50513          	addi	a0,a0,-434 # 5b48 <malloc+0x9ca>
    1d02:	3c8030ef          	jal	50ca <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	9e678793          	addi	a5,a5,-1562 # 7708 <malloc+0x258a>
  ...
  exit(0);
    ...
    1d8e:	0ee50513          	addi	a0,a0,238 # 5e78 <malloc+0xcfa>
    1d92:	338030ef          	jal	50ca <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	daa50513          	addi	a0,a0,-598 # 5b48 <malloc+0x9ca>
    1da6:	324030ef          	jal	50ca <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	2e650513          	addi	a0,a0,742 # 70f0 <malloc+0x1f72>
    1e12:	2b8030ef          	jal	50ca <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	ffc50513          	addi	a0,a0,-4 # 5e98 <malloc+0xd1a>
    1ea4:	226030ef          	jal	50ca <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	4d450513          	addi	a0,a0,1236 # 5388 <malloc+0x20a>
    1ebc:	20e030ef          	jal	50ca <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	c7078793          	addi	a5,a5,-912 # 6b98 <malloc+0x1a1a>
  ...
  if(ret != -1){
    ...
    1f66:	f4e50513          	addi	a0,a0,-178 # 5eb0 <malloc+0xd32>
    1f6a:	160030ef          	jal	50ca <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	af050513          	addi	a0,a0,-1296 # 5a68 <malloc+0x8ea>
    1f80:	14a030ef          	jal	50ca <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	afa50513          	addi	a0,a0,-1286 # 5a88 <malloc+0x90a>
    1f96:	134030ef          	jal	50ca <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	b0250513          	addi	a0,a0,-1278 # 5aa8 <malloc+0x92a>
    1fae:	11c030ef          	jal	50ca <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	b1450513          	addi	a0,a0,-1260 # 5ad0 <malloc+0x952>
    1fc4:	106030ef          	jal	50ca <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	ef850513          	addi	a0,a0,-264 # 5ef0 <malloc+0xd72>
  ...
  if(n >= 0){
    ...
    2024:	ef050513          	addi	a0,a0,-272 # 5f10 <malloc+0xd92>
    2028:	0a2030ef          	jal	50ca <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	e8250513          	addi	a0,a0,-382 # 5eb8 <malloc+0xd3a>
    203e:	08c030ef          	jal	50ca <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	e8650513          	addi	a0,a0,-378 # 5ed0 <malloc+0xd52>
    2052:	078030ef          	jal	50ca <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	42f020ef          	jal	4c86 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	e9c50513          	addi	a0,a0,-356 # 5ef8 <malloc+0xd7a>
    2064:	066030ef          	jal	50ca <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	e7c50513          	addi	a0,a0,-388 # 5ef0 <malloc+0xd72>
    207c:	45b020ef          	jal	4cd6 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	40e50513          	addi	a0,a0,1038 # 5490 <malloc+0x312>
  ...
  if(n >= 0){
    ...
    20a8:	e9c50513          	addi	a0,a0,-356 # 5f40 <malloc+0xdc2>
    20ac:	01e030ef          	jal	50ca <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	3d5020ef          	jal	4c86 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	3e250513          	addi	a0,a0,994 # 5498 <malloc+0x31a>
    20be:	00c030ef          	jal	50ca <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	e4850513          	addi	a0,a0,-440 # 5f68 <malloc+0xdea>
    2128:	7a3020ef          	jal	50ca <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	e1850513          	addi	a0,a0,-488 # 5f88 <malloc+0xe0a>
    2178:	753020ef          	jal	50ca <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	e2c50513          	addi	a0,a0,-468 # 5fe8 <malloc+0xe6a>
    21c4:	707020ef          	jal	50ca <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	dd250513          	addi	a0,a0,-558 # 5fa8 <malloc+0xe2a>
    21de:	6ed020ef          	jal	50ca <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	dde50513          	addi	a0,a0,-546 # 5fc8 <malloc+0xe4a>
    21f2:	6d9020ef          	jal	50ca <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	d3650513          	addi	a0,a0,-714 # 6008 <malloc+0xe8a>
    22da:	5f1020ef          	jal	50ca <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	d6a50513          	addi	a0,a0,-662 # 6050 <malloc+0xed2>
    22ee:	5dd020ef          	jal	50ca <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	d7250513          	addi	a0,a0,-654 # 6070 <malloc+0xef2>
    2306:	5c5020ef          	jal	50ca <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	d9a50513          	addi	a0,a0,-614 # 60b0 <malloc+0xf32>
    231e:	5ad020ef          	jal	50ca <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	db650513          	addi	a0,a0,-586 # 60e0 <malloc+0xf62>
    2332:	599020ef          	jal	50ca <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	dd650513          	addi	a0,a0,-554 # 6118 <malloc+0xf9a>
    234a:	581020ef          	jal	50ca <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	dd050513          	addi	a0,a0,-560 # 6140 <malloc+0xfc2>
    2378:	14f020ef          	jal	4cc6 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	dc250513          	addi	a0,a0,-574 # 6140 <malloc+0xfc2>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	d8a50513          	addi	a0,a0,-630 # 6148 <malloc+0xfca>
    23c6:	505020ef          	jal	50ca <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	d8e50513          	addi	a0,a0,-626 # 6160 <malloc+0xfe2>
    23da:	4f1020ef          	jal	50ca <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	86a50513          	addi	a0,a0,-1942 # 5c50 <malloc+0xad2>
    23ee:	4dd020ef          	jal	50ca <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	d7050513          	addi	a0,a0,-656 # 6178 <malloc+0xffa>
  ...
  close(fd);
    ...
    2444:	72050513          	addi	a0,a0,1824 # 5b60 <malloc+0x9e2>
    2448:	483020ef          	jal	50ca <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	c7a50513          	addi	a0,a0,-902 # 70f0 <malloc+0x1f72>
    247e:	44d020ef          	jal	50ca <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	c4050513          	addi	a0,a0,-960 # 70f0 <malloc+0x1f72>
    24b8:	413020ef          	jal	50ca <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	c0050513          	addi	a0,a0,-1024 # 70f0 <malloc+0x1f72>
    24f8:	3d3020ef          	jal	50ca <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	ae050513          	addi	a0,a0,-1312 # 70f0 <malloc+0x1f72>
    2618:	2b3020ef          	jal	50ca <printf>
      exit(1);
    261c:	4505                	li	a0,1
    ...
    2654:	c6850513          	addi	a0,a0,-920 # 52b8 <malloc+0x13a>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	ccc78793          	addi	a5,a5,-820 # 5328 <malloc+0x1aa>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	b5a50513          	addi	a0,a0,-1190 # 6200 <malloc+0x1082>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	bbc50513          	addi	a0,a0,-1092 # 6278 <malloc+0x10fa>
  ...
  unlink("12345678901234");
    ...
    2744:	a4050513          	addi	a0,a0,-1472 # 6180 <malloc+0x1002>
    2748:	183020ef          	jal	50ca <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	a7450513          	addi	a0,a0,-1420 # 61c8 <malloc+0x104a>
    275c:	16f020ef          	jal	50ca <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	ac850513          	addi	a0,a0,-1336 # 6230 <malloc+0x10b2>
    2770:	15b020ef          	jal	50ca <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	b2c50513          	addi	a0,a0,-1236 # 62a8 <malloc+0x112a>
    2784:	147020ef          	jal	50ca <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	b7850513          	addi	a0,a0,-1160 # 6308 <malloc+0x118a>
    2798:	133020ef          	jal	50ca <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	bbc50513          	addi	a0,a0,-1092 # 6360 <malloc+0x11e2>
    27ac:	11f020ef          	jal	50ca <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	bac50513          	addi	a0,a0,-1108 # 6398 <malloc+0x121a>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	b9050513          	addi	a0,a0,-1136 # 63a8 <malloc+0x122a>
    2820:	0ab020ef          	jal	50ca <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2892:	b0a50513          	addi	a0,a0,-1270 # 6398 <malloc+0x121a>
    2896:	458020ef          	jal	4cee <mkdir>
    289a:	12050063          	beqz	a0,29ba <diskfull+0x204>
  unlink("diskfulldir");
    289e:	00004517          	auipc	a0,0x4
    28a2:	afa50513          	addi	a0,a0,-1286 # 6398 <malloc+0x121a>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	a0c50513          	addi	a0,a0,-1524 # 63c8 <malloc+0x124a>
    29c4:	706020ef          	jal	50ca <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	9de50513          	addi	a0,a0,-1570 # 6400 <malloc+0x1282>
    2a2a:	6a0020ef          	jal	50ca <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	9e250513          	addi	a0,a0,-1566 # 6418 <malloc+0x129a>
    2a3e:	68c020ef          	jal	50ca <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	9fe50513          	addi	a0,a0,-1538 # 6448 <malloc+0x12ca>
    2a52:	678020ef          	jal	50ca <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	a1250513          	addi	a0,a0,-1518 # 6470 <malloc+0x12f2>
    2a66:	664020ef          	jal	50ca <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	08a50513          	addi	a0,a0,138 # 5b48 <malloc+0x9ca>
    2ac6:	604020ef          	jal	50ca <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	92e50513          	addi	a0,a0,-1746 # 6400 <malloc+0x1282>
    2ada:	5f0020ef          	jal	50ca <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	9a250513          	addi	a0,a0,-1630 # 6488 <malloc+0x130a>
    2aee:	5dc020ef          	jal	50ca <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	94e50513          	addi	a0,a0,-1714 # 6448 <malloc+0x12ca>
    2b02:	5c8020ef          	jal	50ca <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	88c50513          	addi	a0,a0,-1908 # 6400 <malloc+0x1282>
    2b7c:	54e020ef          	jal	50ca <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	92050513          	addi	a0,a0,-1760 # 64a8 <malloc+0x132a>
    2b90:	53a020ef          	jal	50ca <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	92c50513          	addi	a0,a0,-1748 # 64c8 <malloc+0x134a>
    2ba4:	526020ef          	jal	50ca <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	93050513          	addi	a0,a0,-1744 # 64e0 <malloc+0x1362>
    2bb8:	512020ef          	jal	50ca <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	a5850513          	addi	a0,a0,-1448 # 6628 <malloc+0x14aa>
    2bd8:	0fe020ef          	jal	4cd6 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	91c50513          	addi	a0,a0,-1764 # 64f8 <malloc+0x137a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	92850513          	addi	a0,a0,-1752 # 6518 <malloc+0x139a>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	a2458593          	addi	a1,a1,-1500 # 6628 <malloc+0x14aa>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	8e250513          	addi	a0,a0,-1822 # 64f8 <malloc+0x137a>
    2c1e:	0b8020ef          	jal	4cd6 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	94a50513          	addi	a0,a0,-1718 # 6570 <malloc+0x13f2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	95e50513          	addi	a0,a0,-1698 # 6598 <malloc+0x141a>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	97a58593          	addi	a1,a1,-1670 # 65c8 <malloc+0x144a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	96e50513          	addi	a0,a0,-1682 # 65d0 <malloc+0x1452>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	85050513          	addi	a0,a0,-1968 # 6598 <malloc+0x141a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	a5450513          	addi	a0,a0,-1452 # 67b0 <malloc+0x1632>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	63250513          	addi	a0,a0,1586 # 6500 <malloc+0x1382>
    2ed6:	1f4020ef          	jal	50ca <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	63e50513          	addi	a0,a0,1598 # 6520 <malloc+0x13a2>
    2eea:	1e0020ef          	jal	50ca <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	64a50513          	addi	a0,a0,1610 # 6540 <malloc+0x13c2>
    2efe:	1cc020ef          	jal	50ca <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	66e50513          	addi	a0,a0,1646 # 6578 <malloc+0x13fa>
    2f12:	1b8020ef          	jal	50ca <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	68a50513          	addi	a0,a0,1674 # 65a8 <malloc+0x142a>
    2f26:	1a4020ef          	jal	50ca <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	6ae50513          	addi	a0,a0,1710 # 65e0 <malloc+0x1462>
    2f3a:	190020ef          	jal	50ca <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	6ba50513          	addi	a0,a0,1722 # 6600 <malloc+0x1482>
    2f4e:	17c020ef          	jal	50ca <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	6d650513          	addi	a0,a0,1750 # 6630 <malloc+0x14b2>
    2f62:	168020ef          	jal	50ca <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	6ea50513          	addi	a0,a0,1770 # 6658 <malloc+0x14da>
    2f76:	154020ef          	jal	50ca <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	6f650513          	addi	a0,a0,1782 # 6678 <malloc+0x14fa>
    2f8a:	140020ef          	jal	50ca <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	70a50513          	addi	a0,a0,1802 # 66a0 <malloc+0x1522>
    2f9e:	12c020ef          	jal	50ca <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	71e50513          	addi	a0,a0,1822 # 66c8 <malloc+0x154a>
    2fb2:	118020ef          	jal	50ca <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	73a50513          	addi	a0,a0,1850 # 66f8 <malloc+0x157a>
    2fc6:	104020ef          	jal	50ca <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	75650513          	addi	a0,a0,1878 # 6728 <malloc+0x15aa>
    2fda:	0f0020ef          	jal	50ca <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	75a50513          	addi	a0,a0,1882 # 6740 <malloc+0x15c2>
    2fee:	0dc020ef          	jal	50ca <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	76650513          	addi	a0,a0,1894 # 6760 <malloc+0x15e2>
    3002:	0c8020ef          	jal	50ca <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	77250513          	addi	a0,a0,1906 # 6780 <malloc+0x1602>
    3016:	0b4020ef          	jal	50ca <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	79e50513          	addi	a0,a0,1950 # 67c0 <malloc+0x1642>
    302a:	0a0020ef          	jal	50ca <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	7ba50513          	addi	a0,a0,1978 # 67f0 <malloc+0x1672>
    303e:	08c020ef          	jal	50ca <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	7c650513          	addi	a0,a0,1990 # 6810 <malloc+0x1692>
    3052:	078020ef          	jal	50ca <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	7d250513          	addi	a0,a0,2002 # 6830 <malloc+0x16b2>
    3066:	064020ef          	jal	50ca <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	7de50513          	addi	a0,a0,2014 # 6850 <malloc+0x16d2>
    307a:	050020ef          	jal	50ca <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	7fa50513          	addi	a0,a0,2042 # 6880 <malloc+0x1702>
    308e:	03c020ef          	jal	50ca <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	80e50513          	addi	a0,a0,-2034 # 68a8 <malloc+0x172a>
    30a2:	028020ef          	jal	50ca <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	82250513          	addi	a0,a0,-2014 # 68d0 <malloc+0x1752>
    30b6:	014020ef          	jal	50ca <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	83650513          	addi	a0,a0,-1994 # 68f8 <malloc+0x177a>
    30ca:	000020ef          	jal	50ca <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	84250513          	addi	a0,a0,-1982 # 6918 <malloc+0x179a>
    30de:	7ed010ef          	jal	50ca <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	84e50513          	addi	a0,a0,-1970 # 6938 <malloc+0x17ba>
    30f2:	7d9010ef          	jal	50ca <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	86250513          	addi	a0,a0,-1950 # 6960 <malloc+0x17e2>
    3106:	7c5010ef          	jal	50ca <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	86e50513          	addi	a0,a0,-1938 # 6980 <malloc+0x1802>
    311a:	7b1010ef          	jal	50ca <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	87a50513          	addi	a0,a0,-1926 # 69a0 <malloc+0x1822>
    312e:	79d010ef          	jal	50ca <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	88e50513          	addi	a0,a0,-1906 # 69c8 <malloc+0x184a>
    3142:	789010ef          	jal	50ca <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	50a50513          	addi	a0,a0,1290 # 6658 <malloc+0x14da>
    3156:	775010ef          	jal	50ca <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	88650513          	addi	a0,a0,-1914 # 69e8 <malloc+0x186a>
    316a:	761010ef          	jal	50ca <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	89250513          	addi	a0,a0,-1902 # 6a08 <malloc+0x188a>
    317e:	74d010ef          	jal	50ca <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	8ae50513          	addi	a0,a0,-1874 # 6a38 <malloc+0x18ba>
    3192:	739010ef          	jal	50ca <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	8ba50513          	addi	a0,a0,-1862 # 6a58 <malloc+0x18da>
    31a6:	725010ef          	jal	50ca <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	84050513          	addi	a0,a0,-1984 # 6a78 <malloc+0x18fa>
    3240:	68b010ef          	jal	50ca <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	84450513          	addi	a0,a0,-1980 # 6a90 <malloc+0x1912>
    3254:	677010ef          	jal	50ca <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	84850513          	addi	a0,a0,-1976 # 6aa8 <malloc+0x192a>
    3268:	663010ef          	jal	50ca <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	84c50513          	addi	a0,a0,-1972 # 6ac0 <malloc+0x1942>
    327c:	64f010ef          	jal	50ca <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	1e850513          	addi	a0,a0,488 # 6470 <malloc+0x12f2>
    3290:	63b010ef          	jal	50ca <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	84450513          	addi	a0,a0,-1980 # 6ae0 <malloc+0x1962>
    32a4:	627010ef          	jal	50ca <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	85850513          	addi	a0,a0,-1960 # 6b08 <malloc+0x198a>
    32b8:	613010ef          	jal	50ca <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	86450513          	addi	a0,a0,-1948 # 6b28 <malloc+0x19aa>
    32cc:	5ff010ef          	jal	50ca <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	86050513          	addi	a0,a0,-1952 # 6b48 <malloc+0x19ca>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	84c50513          	addi	a0,a0,-1972 # 6b48 <malloc+0x19ca>
    3304:	1f3010ef          	jal	4cf6 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	88450513          	addi	a0,a0,-1916 # 6b90 <malloc+0x1a12>
  ...
  fd = open(".", 0);
    ...
    3390:	61450513          	addi	a0,a0,1556 # 59a0 <malloc+0x822>
    3394:	133010ef          	jal	4cc6 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	f8c58593          	addi	a1,a1,-116 # 5328 <malloc+0x1aa>
  ...
  close(fd);
    ...
    33c4:	79050513          	addi	a0,a0,1936 # 6b50 <malloc+0x19d2>
    33c8:	503010ef          	jal	50ca <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	79c50513          	addi	a0,a0,1948 # 6b70 <malloc+0x19f2>
    33dc:	4ef010ef          	jal	50ca <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	7b850513          	addi	a0,a0,1976 # 6ba0 <malloc+0x1a22>
    33f0:	4db010ef          	jal	50ca <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	7a450513          	addi	a0,a0,1956 # 6ba0 <malloc+0x1a22>
    3404:	4c7010ef          	jal	50ca <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	7b850513          	addi	a0,a0,1976 # 6bc8 <malloc+0x1a4a>
    3418:	4b3010ef          	jal	50ca <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	7cc50513          	addi	a0,a0,1996 # 6bf0 <malloc+0x1a72>
    342c:	49f010ef          	jal	50ca <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	7e050513          	addi	a0,a0,2016 # 6c18 <malloc+0x1a9a>
    3440:	48b010ef          	jal	50ca <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	7f450513          	addi	a0,a0,2036 # 6c40 <malloc+0x1ac2>
    3454:	477010ef          	jal	50ca <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	80050513          	addi	a0,a0,-2048 # 6c60 <malloc+0x1ae2>
    3468:	463010ef          	jal	50ca <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	81450513          	addi	a0,a0,-2028 # 6c88 <malloc+0x1b0a>
    347c:	44f010ef          	jal	50ca <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	800a0a13          	addi	s4,s4,-2048 # 6ca0 <malloc+0x1b22>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	30048493          	addi	s1,s1,768 # 67a8 <malloc+0x162a>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	fe0a8a93          	addi	s5,s5,-32 # 5490 <malloc+0x312>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	6e098993          	addi	s3,s3,1760 # 6b98 <malloc+0x1a1a>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00003517          	auipc	a0,0x3
    34c8:	7e450513          	addi	a0,a0,2020 # 6ca8 <malloc+0x1b2a>
    34cc:	3ff010ef          	jal	50ca <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	7e850513          	addi	a0,a0,2024 # 6cc0 <malloc+0x1b42>
    34e0:	3eb010ef          	jal	50ca <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	f8098993          	addi	s3,s3,-128 # 64c0 <malloc+0x1342>
    unlink("irefd");
    3548:	00003917          	auipc	s2,0x3
    354c:	75890913          	addi	s2,s2,1880 # 6ca0 <malloc+0x1b22>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	f0850513          	addi	a0,a0,-248 # 6468 <malloc+0x12ea>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	74c50513          	addi	a0,a0,1868 # 6cd8 <malloc+0x1b5a>
  ...
  if(pid == 0){
    ...
    35ac:	73050513          	addi	a0,a0,1840 # 6cd8 <malloc+0x1b5a>
    ...
    35be:	73e50513          	addi	a0,a0,1854 # 6cf8 <malloc+0x1b7a>
    35c2:	309010ef          	jal	50ca <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	71250513          	addi	a0,a0,1810 # 6ce0 <malloc+0x1b62>
    35d6:	2f5010ef          	jal	50ca <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	56650513          	addi	a0,a0,1382 # 5b48 <malloc+0x9ca>
    35ea:	2e1010ef          	jal	50ca <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	6d850513          	addi	a0,a0,1752 # 6cd8 <malloc+0x1b5a>
    3608:	6ce010ef          	jal	4cd6 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00002517          	auipc	a0,0x2
    3614:	72850513          	addi	a0,a0,1832 # 5d38 <malloc+0xbba>
    3618:	2b3010ef          	jal	50ca <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	6e250513          	addi	a0,a0,1762 # 6d20 <malloc+0x1ba2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	6c250513          	addi	a0,a0,1730 # 6d20 <malloc+0x1ba2>
  ...
  pause(10); // one second
    ...
    368a:	68250513          	addi	a0,a0,1666 # 5d08 <malloc+0xb8a>
    368e:	23d010ef          	jal	50ca <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	5f2010ef          	jal	4c86 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	68848493          	addi	s1,s1,1672 # 6d20 <malloc+0x1ba2>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	66850513          	addi	a0,a0,1640 # 6d20 <malloc+0x1ba2>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	42a50513          	addi	a0,a0,1066 # 5b48 <malloc+0x9ca>
    3726:	1a5010ef          	jal	50ca <printf>
      exit(1);
    372a:	4505                	li	a0,1
    ...
    373c:	5f850513          	addi	a0,a0,1528 # 6d30 <malloc+0x1bb2>
    3740:	18b010ef          	jal	50ca <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	59c50513          	addi	a0,a0,1436 # 5d08 <malloc+0xb8a>
    3774:	157010ef          	jal	50ca <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	3ba50513          	addi	a0,a0,954 # 5b48 <malloc+0x9ca>
    3796:	135010ef          	jal	50ca <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	b6a58593          	addi	a1,a1,-1174 # 5328 <malloc+0x1aa>
    ...
    37e4:	36850513          	addi	a0,a0,872 # 5b48 <malloc+0x9ca>
    37e8:	0e3010ef          	jal	50ca <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	55c50513          	addi	a0,a0,1372 # 6d50 <malloc+0x1bd2>
    37fc:	0cf010ef          	jal	50ca <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	54450513          	addi	a0,a0,1348 # 6d68 <malloc+0x1bea>
    382c:	09f010ef          	jal	50ca <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	53850513          	addi	a0,a0,1336 # 6d80 <malloc+0x1c02>
    3850:	07b010ef          	jal	50ca <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    386a:	52a50513          	addi	a0,a0,1322 # 6d90 <malloc+0x1c12>
    386e:	05d010ef          	jal	50ca <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	28250513          	addi	a0,a0,642 # 5b48 <malloc+0x9ca>
    38ce:	7fc010ef          	jal	50ca <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	3f650513          	addi	a0,a0,1014 # 5cd0 <malloc+0xb52>
    38e2:	7e8010ef          	jal	50ca <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	31250513          	addi	a0,a0,786 # 5c50 <malloc+0xad2>
    3946:	784010ef          	jal	50ca <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	ac858593          	addi	a1,a1,-1336 # 7430 <malloc+0x22b2>
    ...
    3988:	41c58593          	addi	a1,a1,1052 # 6da0 <malloc+0x1c22>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	3d250513          	addi	a0,a0,978 # 6da8 <malloc+0x1c2a>
    39de:	6ec010ef          	jal	50ca <printf>
  ...
  if(pid == 0){
    ...
    3a24:	3d850513          	addi	a0,a0,984 # 6df8 <malloc+0x1c7a>
    3a28:	6a2010ef          	jal	50ca <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	3a450513          	addi	a0,a0,932 # 6dd8 <malloc+0x1c5a>
    3a3c:	68e010ef          	jal	50ca <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	10050513          	addi	a0,a0,256 # 5b48 <malloc+0x9ca>
    3a50:	67a010ef          	jal	50ca <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	62c010ef          	jal	50fc <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	6a6010ef          	jal	517e <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	61e010ef          	jal	50fc <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	33e50513          	addi	a0,a0,830 # 6e28 <malloc+0x1caa>
    3af2:	5d8010ef          	jal	50ca <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	33a50513          	addi	a0,a0,826 # 6e48 <malloc+0x1cca>
    3b16:	1c0010ef          	jal	4cd6 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	32a50513          	addi	a0,a0,810 # 6e48 <malloc+0x1cca>
  ...
  if(pid == 0) {
    ...
    3b8c:	2d050513          	addi	a0,a0,720 # 6e58 <malloc+0x1cda>
    3b90:	53a010ef          	jal	50ca <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	2e450513          	addi	a0,a0,740 # 6e80 <malloc+0x1d02>
    3ba4:	526010ef          	jal	50ca <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	27c50513          	addi	a0,a0,636 # 6e48 <malloc+0x1cca>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	29c50513          	addi	a0,a0,668 # 6ea0 <malloc+0x1d22>
    3c0c:	4be010ef          	jal	50ca <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	21450513          	addi	a0,a0,532 # 6e48 <malloc+0x1cca>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	27250513          	addi	a0,a0,626 # 6ec8 <malloc+0x1d4a>
    3c5e:	46c010ef          	jal	50ca <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	25278793          	addi	a5,a5,594 # 6ee0 <malloc+0x1d62>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	24e78793          	addi	a5,a5,590 # 6ee8 <malloc+0x1d6a>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	24a78793          	addi	a5,a5,586 # 6ef0 <malloc+0x1d72>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	24678793          	addi	a5,a5,582 # 6ef8 <malloc+0x1d7a>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	e3450513          	addi	a0,a0,-460 # 5b48 <malloc+0x9ca>
    3d1c:	3ae010ef          	jal	50ca <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	e6a50513          	addi	a0,a0,-406 # 5be0 <malloc+0xa62>
    3d7e:	34c010ef          	jal	50ca <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	703000ef          	jal	4c86 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	17850513          	addi	a0,a0,376 # 6f00 <malloc+0x1d82>
    3d90:	33a010ef          	jal	50ca <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	17650513          	addi	a0,a0,374 # 6f18 <malloc+0x1d9a>
    3daa:	320010ef          	jal	50ca <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	11650513          	addi	a0,a0,278 # 6f28 <malloc+0x1daa>
    3e1a:	2b0010ef          	jal	50ca <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	0d4b8b93          	addi	s7,s7,212 # 6f40 <malloc+0x1dc2>
  for(i = 0; i < N; i++){
    ...
    3eaa:	0a250513          	addi	a0,a0,162 # 6f48 <malloc+0x1dca>
    3eae:	21c010ef          	jal	50ca <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	08450513          	addi	a0,a0,132 # 6f40 <malloc+0x1dc2>
  ...
  fd = open(".", 0);
    ...
    3ee8:	abc50513          	addi	a0,a0,-1348 # 59a0 <malloc+0x822>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	01450513          	addi	a0,a0,20 # 6f68 <malloc+0x1dea>
    3f5c:	16e010ef          	jal	50ca <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	01c50513          	addi	a0,a0,28 # 6f88 <malloc+0x1e0a>
    3f74:	156010ef          	jal	50ca <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	01850513          	addi	a0,a0,24 # 6fb0 <malloc+0x1e32>
    3fa0:	12a010ef          	jal	50ca <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	b9c50513          	addi	a0,a0,-1124 # 5b48 <malloc+0x9ca>
    3fb4:	116010ef          	jal	50ca <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	eee50513          	addi	a0,a0,-274 # 6fe8 <malloc+0x1e6a>
    4102:	3d5000ef          	jal	4cd6 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	ede50513          	addi	a0,a0,-290 # 6fe8 <malloc+0x1e6a>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	e9250513          	addi	a0,a0,-366 # 6fe8 <malloc+0x1e6a>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	e4650513          	addi	a0,a0,-442 # 6ff8 <malloc+0x1e7a>
    41ba:	711000ef          	jal	50ca <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	e5250513          	addi	a0,a0,-430 # 7018 <malloc+0x1e9a>
    41ce:	6fd000ef          	jal	50ca <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	e5e50513          	addi	a0,a0,-418 # 7038 <malloc+0x1eba>
    41e2:	6e9000ef          	jal	50ca <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	e6a50513          	addi	a0,a0,-406 # 7058 <malloc+0x1eda>
    41f6:	6d5000ef          	jal	50ca <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	e7650513          	addi	a0,a0,-394 # 7078 <malloc+0x1efa>
    420a:	6c1000ef          	jal	50ca <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	e7a50513          	addi	a0,a0,-390 # 7090 <malloc+0x1f12>
    421e:	6ad000ef          	jal	50ca <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	db050513          	addi	a0,a0,-592 # 6fe8 <malloc+0x1e6a>
    ...
    425c:	e5850513          	addi	a0,a0,-424 # 70b0 <malloc+0x1f32>
    4260:	66b000ef          	jal	50ca <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	e5a50513          	addi	a0,a0,-422 # 70d0 <malloc+0x1f52>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	e3450513          	addi	a0,a0,-460 # 70d0 <malloc+0x1f52>
  ...
  close(fd);
    ...
    42fa:	fc250513          	addi	a0,a0,-62 # 52b8 <malloc+0x13a>
    42fe:	1c1000ef          	jal	4cbe <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	dca50513          	addi	a0,a0,-566 # 70d0 <malloc+0x1f52>
    ...
    4322:	dc250513          	addi	a0,a0,-574 # 70e0 <malloc+0x1f62>
    4326:	5a5000ef          	jal	50ca <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	dca50513          	addi	a0,a0,-566 # 7100 <malloc+0x1f82>
    433e:	58d000ef          	jal	50ca <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	d9250513          	addi	a0,a0,-622 # 7120 <malloc+0x1fa2>
    4396:	535000ef          	jal	50ca <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	0eb000ef          	jal	4c86 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	d9850513          	addi	a0,a0,-616 # 7138 <malloc+0x1fba>
    43a8:	523000ef          	jal	50ca <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	d0a50513          	addi	a0,a0,-758 # 7120 <malloc+0x1fa2>
    441e:	4ad000ef          	jal	50ca <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	063000ef          	jal	4c86 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	d3850513          	addi	a0,a0,-712 # 7160 <malloc+0x1fe2>
    4430:	49b000ef          	jal	50ca <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	d2450513          	addi	a0,a0,-732 # 7170 <malloc+0x1ff2>
    4454:	477000ef          	jal	50ca <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	ce650513          	addi	a0,a0,-794 # 7188 <malloc+0x200a>
    44aa:	421000ef          	jal	50ca <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	7d6000ef          	jal	4c86 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	25478793          	addi	a5,a5,596 # 7708 <malloc+0x258a>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	fa8a0a13          	addi	s4,s4,-88 # 5490 <malloc+0x312>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	eb0a8a93          	addi	s5,s5,-336 # 53a0 <malloc+0x222>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4552:	c6a50513          	addi	a0,a0,-918 # 71b8 <malloc+0x203a>
    4556:	375000ef          	jal	50ca <printf>
    455a:	4505                	li	a0,1
    455c:	72a000ef          	jal	4c86 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	c7050513          	addi	a0,a0,-912 # 71d0 <malloc+0x2052>
    4568:	363000ef          	jal	50ca <printf>
    456c:	4505                	li	a0,1
    456e:	718000ef          	jal	4c86 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	c6e50513          	addi	a0,a0,-914 # 71e0 <malloc+0x2062>
    457a:	351000ef          	jal	50ca <printf>
    457e:	4505                	li	a0,1
    4580:	706000ef          	jal	4c86 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	c7450513          	addi	a0,a0,-908 # 71f8 <malloc+0x207a>
    458c:	33f000ef          	jal	50ca <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    45b6:	c5e50513          	addi	a0,a0,-930 # 7210 <malloc+0x2092>
    45ba:	311000ef          	jal	50ca <printf>
  for(nfiles = 0; ; nfiles++){
    45be:	4481                	li	s1,0
    name[0] = 'f';
    ...
    45d2:	c52c8c93          	addi	s9,s9,-942 # 7220 <malloc+0x20a2>
    name[0] = 'f';
    ...
    463a:	bfa50513          	addi	a0,a0,-1030 # 7230 <malloc+0x20b2>
    463e:	28d000ef          	jal	50ca <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    46a8:	bac50513          	addi	a0,a0,-1108 # 7250 <malloc+0x20d2>
    46ac:	21f000ef          	jal	50ca <printf>
}
    ...
    46f6:	b4e50513          	addi	a0,a0,-1202 # 7240 <malloc+0x20c2>
    46fa:	1d1000ef          	jal	50ca <printf>
    close(fd);
    46fe:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4720:	b4c50513          	addi	a0,a0,-1204 # 7268 <malloc+0x20ea>
    4724:	1a7000ef          	jal	50ca <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4744:	b5050513          	addi	a0,a0,-1200 # 7290 <malloc+0x2112>
    4748:	183000ef          	jal	50ca <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4764:	b1850513          	addi	a0,a0,-1256 # 7278 <malloc+0x20fa>
    4768:	163000ef          	jal	50ca <printf>
    exit(1);
    476c:	4505                	li	a0,1
    ...
    4780:	b1c50513          	addi	a0,a0,-1252 # 7298 <malloc+0x211a>
    4784:	147000ef          	jal	50ca <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    47d2:	ad250513          	addi	a0,a0,-1326 # 72a0 <malloc+0x2122>
    47d6:	0f5000ef          	jal	50ca <printf>
          return -1;
    47da:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    486a:	a52c0c13          	addi	s8,s8,-1454 # 72b8 <malloc+0x213a>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4884:	a50d8d93          	addi	s11,s11,-1456 # 72d0 <malloc+0x2152>
      } else {
        ntests += n;
      }
    }
    ...
    488c:	a68d0d13          	addi	s10,s10,-1432 # 72f0 <malloc+0x2172>
    ...
    4906:	a1e50513          	addi	a0,a0,-1506 # 7320 <malloc+0x21a2>
    490a:	7c0000ef          	jal	50ca <printf>
      return 1;
    490e:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4970:	9cc58593          	addi	a1,a1,-1588 # 7338 <malloc+0x21ba>
  ...
  int continuous = 0;
    ...
    49c4:	98850513          	addi	a0,a0,-1656 # 7348 <malloc+0x21ca>
    49c8:	702000ef          	jal	50ca <printf>
    exit(1);
    49cc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    49e2:	99a50513          	addi	a0,a0,-1638 # 7378 <malloc+0x21fa>
    49e6:	6e4000ef          	jal	50ca <printf>
  exit(0);
    49ea:	4501                	li	a0,0
...
putc(int fd, char c)
{
    ...
    4d38:	ec06                	sd	ra,24(sp)
    4d3a:	e822                	sd	s0,16(sp)
    4d3c:	1000                	addi	s0,sp,32
    4d3e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4d42:	4605                	li	a2,1
    4d44:	fef40593          	addi	a1,s0,-17
    4d48:	f5fff0ef          	jal	4ca6 <write>
}
    4d4c:	60e2                	ld	ra,24(sp)
    4d4e:	6442                	ld	s0,16(sp)
    4d50:	6105                	addi	sp,sp,32
    4d52:	8082                	ret

0000000000004d54 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4d54:	715d                	addi	sp,sp,-80
    4d56:	e486                	sd	ra,72(sp)
    4d58:	e0a2                	sd	s0,64(sp)
    4d5a:	fc26                	sd	s1,56(sp)
    4d5c:	0880                	addi	s0,sp,80
    4d5e:	84aa                	mv	s1,a0
  char buf[20];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4d60:	c299                	beqz	a3,4d66 <printint+0x12>
    4d62:	0805c963          	bltz	a1,4df4 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4d66:	2581                	sext.w	a1,a1
  neg = 0;
    4d68:	4881                	li	a7,0
    4d6a:	fb840693          	addi	a3,s0,-72
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4d70:	2601                	sext.w	a2,a2
    4d72:	00003517          	auipc	a0,0x3
    4d76:	a3e50513          	addi	a0,a0,-1474 # 77b0 <digits>
    4d7a:	883a                	mv	a6,a4
    4d7c:	2705                	addiw	a4,a4,1
    4d7e:	02c5f7bb          	remuw	a5,a1,a2
    4d82:	1782                	slli	a5,a5,0x20
    4d84:	9381                	srli	a5,a5,0x20
    4d86:	97aa                	add	a5,a5,a0
    4d88:	0007c783          	lbu	a5,0(a5)
    4d8c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4d90:	0005879b          	sext.w	a5,a1
    4d94:	02c5d5bb          	divuw	a1,a1,a2
    4d98:	0685                	addi	a3,a3,1
    4d9a:	fec7f0e3          	bgeu	a5,a2,4d7a <printint+0x26>
  if(neg)
    4d9e:	00088c63          	beqz	a7,4db6 <printint+0x62>
    buf[i++] = '-';
    4da2:	fd070793          	addi	a5,a4,-48
    4da6:	00878733          	add	a4,a5,s0
    4daa:	02d00793          	li	a5,45
    4dae:	fef70423          	sb	a5,-24(a4)
    4db2:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4db6:	02e05a63          	blez	a4,4dea <printint+0x96>
    4dba:	f84a                	sd	s2,48(sp)
    4dbc:	f44e                	sd	s3,40(sp)
    4dbe:	fb840793          	addi	a5,s0,-72
    4dc2:	00e78933          	add	s2,a5,a4
    4dc6:	fff78993          	addi	s3,a5,-1
    4dca:	99ba                	add	s3,s3,a4
    4dcc:	377d                	addiw	a4,a4,-1
    4dce:	1702                	slli	a4,a4,0x20
    4dd0:	9301                	srli	a4,a4,0x20
    4dd2:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4dd6:	fff94583          	lbu	a1,-1(s2)
    4dda:	8526                	mv	a0,s1
    4ddc:	f5bff0ef          	jal	4d36 <putc>
  while(--i >= 0)
    4de0:	197d                	addi	s2,s2,-1
    4de2:	ff391ae3          	bne	s2,s3,4dd6 <printint+0x82>
    4de6:	7942                	ld	s2,48(sp)
    4de8:	79a2                	ld	s3,40(sp)
}
    4dea:	60a6                	ld	ra,72(sp)
    4dec:	6406                	ld	s0,64(sp)
    4dee:	74e2                	ld	s1,56(sp)
    4df0:	6161                	addi	sp,sp,80
    4df2:	8082                	ret
    x = -xx;
    4df4:	40b005bb          	negw	a1,a1
    neg = 1;
    4df8:	4885                	li	a7,1
    x = -xx;
    4dfa:	bf85                	j	4d6a <printint+0x16>

0000000000004dfc <vprintf>:
}
...
{
    4dfc:	711d                	addi	sp,sp,-96
    4dfe:	ec86                	sd	ra,88(sp)
    4e00:	e8a2                	sd	s0,80(sp)
    4e02:	e0ca                	sd	s2,64(sp)
    4e04:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4e06:	0005c903          	lbu	s2,0(a1)
    4e0a:	28090663          	beqz	s2,5096 <vprintf+0x29a>
    4e0e:	e4a6                	sd	s1,72(sp)
    4e10:	fc4e                	sd	s3,56(sp)
    4e12:	f852                	sd	s4,48(sp)
    4e14:	f456                	sd	s5,40(sp)
    4e16:	f05a                	sd	s6,32(sp)
    4e18:	ec5e                	sd	s7,24(sp)
    4e1a:	e862                	sd	s8,16(sp)
    4e1c:	e466                	sd	s9,8(sp)
    4e1e:	8b2a                	mv	s6,a0
    4e20:	8a2e                	mv	s4,a1
    4e22:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4e2a:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4e2e:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4e32:	06c00c93          	li	s9,108
    4e36:	a005                	j	4e56 <vprintf+0x5a>
        putc(fd, c0);
    4e38:	85ca                	mv	a1,s2
    4e3a:	855a                	mv	a0,s6
    4e3c:	efbff0ef          	jal	4d36 <putc>
    4e40:	a019                	j	4e46 <vprintf+0x4a>
    } else if(state == '%'){
    4e42:	03598263          	beq	s3,s5,4e66 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4e46:	2485                	addiw	s1,s1,1
    4e48:	8726                	mv	a4,s1
    4e4a:	009a07b3          	add	a5,s4,s1
    4e4e:	0007c903          	lbu	s2,0(a5)
    4e52:	22090a63          	beqz	s2,5086 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4e56:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4e5a:	fe0994e3          	bnez	s3,4e42 <vprintf+0x46>
      if(c0 == '%'){
    4e5e:	fd579de3          	bne	a5,s5,4e38 <vprintf+0x3c>
        state = '%';
    4e62:	89be                	mv	s3,a5
    4e64:	b7cd                	j	4e46 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4e66:	00ea06b3          	add	a3,s4,a4
    4e6a:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4e6e:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4e70:	c681                	beqz	a3,4e78 <vprintf+0x7c>
    4e72:	9752                	add	a4,a4,s4
    4e74:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4e78:	05878363          	beq	a5,s8,4ebe <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4e7c:	05978d63          	beq	a5,s9,4ed6 <vprintf+0xda>
    ...
    4e80:	07500713          	li	a4,117
    4e84:	0ee78763          	beq	a5,a4,4f72 <vprintf+0x176>
    ...
    4e88:	07800713          	li	a4,120
    4e8c:	12e78963          	beq	a5,a4,4fbe <vprintf+0x1c2>
    ...
    4e90:	07000713          	li	a4,112
    4e94:	14e78e63          	beq	a5,a4,4ff0 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4e98:	06300713          	li	a4,99
    4e9c:	18e78e63          	beq	a5,a4,5038 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4ea0:	07300713          	li	a4,115
    4ea4:	1ae78463          	beq	a5,a4,504c <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4ea8:	02500713          	li	a4,37
    4eac:	04e79563          	bne	a5,a4,4ef6 <vprintf+0xfa>
        putc(fd, '%');
    4eb0:	02500593          	li	a1,37
    4eb4:	855a                	mv	a0,s6
    4eb6:	e81ff0ef          	jal	4d36 <putc>
      ...
      state = 0;
    4eba:	4981                	li	s3,0
    4ebc:	b769                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4ebe:	008b8913          	addi	s2,s7,8
    4ec2:	4685                	li	a3,1
    4ec4:	4629                	li	a2,10
    4ec6:	000ba583          	lw	a1,0(s7)
    4eca:	855a                	mv	a0,s6
    4ecc:	e89ff0ef          	jal	4d54 <printint>
    4ed0:	8bca                	mv	s7,s2
      state = 0;
    4ed2:	4981                	li	s3,0
    4ed4:	bf8d                	j	4e46 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4ed6:	06400793          	li	a5,100
    4eda:	02f68963          	beq	a3,a5,4f0c <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ede:	06c00793          	li	a5,108
    4ee2:	04f68263          	beq	a3,a5,4f26 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4ee6:	07500793          	li	a5,117
    4eea:	0af68063          	beq	a3,a5,4f8a <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    4eee:	07800793          	li	a5,120
    4ef2:	0ef68263          	beq	a3,a5,4fd6 <vprintf+0x1da>
        putc(fd, '%');
    4ef6:	02500593          	li	a1,37
    4efa:	855a                	mv	a0,s6
    4efc:	e3bff0ef          	jal	4d36 <putc>
        putc(fd, c0);
    4f00:	85ca                	mv	a1,s2
    4f02:	855a                	mv	a0,s6
    4f04:	e33ff0ef          	jal	4d36 <putc>
      state = 0;
    4f08:	4981                	li	s3,0
    4f0a:	bf35                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f0c:	008b8913          	addi	s2,s7,8
    4f10:	4685                	li	a3,1
    4f12:	4629                	li	a2,10
    4f14:	000bb583          	ld	a1,0(s7)
    4f18:	855a                	mv	a0,s6
    4f1a:	e3bff0ef          	jal	4d54 <printint>
        i += 1;
    4f1e:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f20:	8bca                	mv	s7,s2
      state = 0;
    4f22:	4981                	li	s3,0
        i += 1;
    4f24:	b70d                	j	4e46 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f26:	06400793          	li	a5,100
    4f2a:	02f60763          	beq	a2,a5,4f58 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4f2e:	07500793          	li	a5,117
    4f32:	06f60963          	beq	a2,a5,4fa4 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4f36:	07800793          	li	a5,120
    4f3a:	faf61ee3          	bne	a2,a5,4ef6 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4f3e:	008b8913          	addi	s2,s7,8
    4f42:	4681                	li	a3,0
    4f44:	4641                	li	a2,16
    4f46:	000bb583          	ld	a1,0(s7)
    4f4a:	855a                	mv	a0,s6
    4f4c:	e09ff0ef          	jal	4d54 <printint>
        i += 2;
    4f50:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4f52:	8bca                	mv	s7,s2
      state = 0;
    4f54:	4981                	li	s3,0
        i += 2;
    4f56:	bdc5                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f58:	008b8913          	addi	s2,s7,8
    4f5c:	4685                	li	a3,1
    4f5e:	4629                	li	a2,10
    4f60:	000bb583          	ld	a1,0(s7)
    4f64:	855a                	mv	a0,s6
    4f66:	defff0ef          	jal	4d54 <printint>
        i += 2;
    4f6a:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4f6c:	8bca                	mv	s7,s2
      state = 0;
    4f6e:	4981                	li	s3,0
        i += 2;
    4f70:	bdd9                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    4f72:	008b8913          	addi	s2,s7,8
    4f76:	4681                	li	a3,0
    4f78:	4629                	li	a2,10
    4f7a:	000be583          	lwu	a1,0(s7)
    4f7e:	855a                	mv	a0,s6
    4f80:	dd5ff0ef          	jal	4d54 <printint>
    4f84:	8bca                	mv	s7,s2
      state = 0;
    4f86:	4981                	li	s3,0
    4f88:	bd7d                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4f8a:	008b8913          	addi	s2,s7,8
    4f8e:	4681                	li	a3,0
    4f90:	4629                	li	a2,10
    4f92:	000bb583          	ld	a1,0(s7)
    4f96:	855a                	mv	a0,s6
    4f98:	dbdff0ef          	jal	4d54 <printint>
        i += 1;
    ...
    4fa0:	4981                	li	s3,0
        i += 1;
    4fa2:	b555                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fa4:	008b8913          	addi	s2,s7,8
    4fa8:	4681                	li	a3,0
    4faa:	4629                	li	a2,10
    4fac:	000bb583          	ld	a1,0(s7)
    4fb0:	855a                	mv	a0,s6
    4fb2:	da3ff0ef          	jal	4d54 <printint>
        i += 2;
    4fb6:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4fb8:	8bca                	mv	s7,s2
      state = 0;
    4fba:	4981                	li	s3,0
        i += 2;
    4fbc:	b569                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    4fbe:	008b8913          	addi	s2,s7,8
    4fc2:	4681                	li	a3,0
    4fc4:	4641                	li	a2,16
    4fc6:	000be583          	lwu	a1,0(s7)
    4fca:	855a                	mv	a0,s6
    4fcc:	d89ff0ef          	jal	4d54 <printint>
    4fd0:	8bca                	mv	s7,s2
      state = 0;
    4fd2:	4981                	li	s3,0
    4fd4:	bd8d                	j	4e46 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4fd6:	008b8913          	addi	s2,s7,8
    4fda:	4681                	li	a3,0
    4fdc:	4641                	li	a2,16
    4fde:	000bb583          	ld	a1,0(s7)
    4fe2:	855a                	mv	a0,s6
    4fe4:	d71ff0ef          	jal	4d54 <printint>
        i += 1;
    ...
    4fec:	4981                	li	s3,0
        i += 1;
    4fee:	bda1                	j	4e46 <vprintf+0x4a>
    4ff0:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    4ff2:	008b8d13          	addi	s10,s7,8
    4ff6:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4ffa:	03000593          	li	a1,48
    4ffe:	855a                	mv	a0,s6
    5000:	d37ff0ef          	jal	4d36 <putc>
  putc(fd, 'x');
    5004:	07800593          	li	a1,120
    5008:	855a                	mv	a0,s6
    500a:	d2dff0ef          	jal	4d36 <putc>
    500e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5010:	00002b97          	auipc	s7,0x2
    5014:	7a0b8b93          	addi	s7,s7,1952 # 77b0 <digits>
    5018:	03c9d793          	srli	a5,s3,0x3c
    501c:	97de                	add	a5,a5,s7
    501e:	0007c583          	lbu	a1,0(a5)
    5022:	855a                	mv	a0,s6
    5024:	d13ff0ef          	jal	4d36 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5028:	0992                	slli	s3,s3,0x4
    502a:	397d                	addiw	s2,s2,-1
    502c:	fe0916e3          	bnez	s2,5018 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5030:	8bea                	mv	s7,s10
      state = 0;
    5032:	4981                	li	s3,0
    5034:	6d02                	ld	s10,0(sp)
    5036:	bd01                	j	4e46 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    5038:	008b8913          	addi	s2,s7,8
    503c:	000bc583          	lbu	a1,0(s7)
    5040:	855a                	mv	a0,s6
    5042:	cf5ff0ef          	jal	4d36 <putc>
    5046:	8bca                	mv	s7,s2
      state = 0;
    5048:	4981                	li	s3,0
    504a:	bbf5                	j	4e46 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    504c:	008b8993          	addi	s3,s7,8
    5050:	000bb903          	ld	s2,0(s7)
    5054:	00090f63          	beqz	s2,5072 <vprintf+0x276>
        for(; *s; s++)
    5058:	00094583          	lbu	a1,0(s2)
    505c:	c195                	beqz	a1,5080 <vprintf+0x284>
          putc(fd, *s);
    505e:	855a                	mv	a0,s6
    5060:	cd7ff0ef          	jal	4d36 <putc>
        for(; *s; s++)
    5064:	0905                	addi	s2,s2,1
    5066:	00094583          	lbu	a1,0(s2)
    506a:	f9f5                	bnez	a1,505e <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    506c:	8bce                	mv	s7,s3
      state = 0;
    506e:	4981                	li	s3,0
    5070:	bbd9                	j	4e46 <vprintf+0x4a>
          s = "(null)";
    5072:	00002917          	auipc	s2,0x2
    5076:	68e90913          	addi	s2,s2,1678 # 7700 <malloc+0x2582>
        for(; *s; s++)
    507a:	02800593          	li	a1,40
    507e:	b7c5                	j	505e <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5080:	8bce                	mv	s7,s3
      state = 0;
    5082:	4981                	li	s3,0
    5084:	b3c9                	j	4e46 <vprintf+0x4a>
    5086:	64a6                	ld	s1,72(sp)
    5088:	79e2                	ld	s3,56(sp)
    508a:	7a42                	ld	s4,48(sp)
    508c:	7aa2                	ld	s5,40(sp)
    508e:	7b02                	ld	s6,32(sp)
    5090:	6be2                	ld	s7,24(sp)
    5092:	6c42                	ld	s8,16(sp)
    5094:	6ca2                	ld	s9,8(sp)
    }
  }
}
    5096:	60e6                	ld	ra,88(sp)
    5098:	6446                	ld	s0,80(sp)
    509a:	6906                	ld	s2,64(sp)
    509c:	6125                	addi	sp,sp,96
    509e:	8082                	ret

00000000000050a0 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    50a0:	715d                	addi	sp,sp,-80
    50a2:	ec06                	sd	ra,24(sp)
    50a4:	e822                	sd	s0,16(sp)
    50a6:	1000                	addi	s0,sp,32
    50a8:	e010                	sd	a2,0(s0)
    50aa:	e414                	sd	a3,8(s0)
    50ac:	e818                	sd	a4,16(s0)
    50ae:	ec1c                	sd	a5,24(s0)
    50b0:	03043023          	sd	a6,32(s0)
    50b4:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    50b8:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    50bc:	8622                	mv	a2,s0
    50be:	d3fff0ef          	jal	4dfc <vprintf>
}
    50c2:	60e2                	ld	ra,24(sp)
    50c4:	6442                	ld	s0,16(sp)
    50c6:	6161                	addi	sp,sp,80
    50c8:	8082                	ret

00000000000050ca <printf>:

void
printf(const char *fmt, ...)
{
    50ca:	711d                	addi	sp,sp,-96
    50cc:	ec06                	sd	ra,24(sp)
    50ce:	e822                	sd	s0,16(sp)
    50d0:	1000                	addi	s0,sp,32
    50d2:	e40c                	sd	a1,8(s0)
    50d4:	e810                	sd	a2,16(s0)
    50d6:	ec14                	sd	a3,24(s0)
    50d8:	f018                	sd	a4,32(s0)
    50da:	f41c                	sd	a5,40(s0)
    50dc:	03043823          	sd	a6,48(s0)
    50e0:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    50e4:	00840613          	addi	a2,s0,8
    50e8:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    50ec:	85aa                	mv	a1,a0
    50ee:	4505                	li	a0,1
    50f0:	d0dff0ef          	jal	4dfc <vprintf>
}
    50f4:	60e2                	ld	ra,24(sp)
    50f6:	6442                	ld	s0,16(sp)
    50f8:	6125                	addi	sp,sp,96
    50fa:	8082                	ret

00000000000050fc <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    50fc:	1141                	addi	sp,sp,-16
    50fe:	e422                	sd	s0,8(sp)
    5100:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5102:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5106:	00004797          	auipc	a5,0x4
    510a:	37a7b783          	ld	a5,890(a5) # 9480 <freep>
    510e:	a02d                	j	5138 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5110:	4618                	lw	a4,8(a2)
    5112:	9f2d                	addw	a4,a4,a1
    5114:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5118:	6398                	ld	a4,0(a5)
    511a:	6310                	ld	a2,0(a4)
    511c:	a83d                	j	515a <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    511e:	ff852703          	lw	a4,-8(a0)
    5122:	9f31                	addw	a4,a4,a2
    5124:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5126:	ff053683          	ld	a3,-16(a0)
    512a:	a091                	j	516e <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    512c:	6398                	ld	a4,0(a5)
    512e:	00e7e463          	bltu	a5,a4,5136 <free+0x3a>
    5132:	00e6ea63          	bltu	a3,a4,5146 <free+0x4a>
{
    5136:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5138:	fed7fae3          	bgeu	a5,a3,512c <free+0x30>
    513c:	6398                	ld	a4,0(a5)
    513e:	00e6e463          	bltu	a3,a4,5146 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5142:	fee7eae3          	bltu	a5,a4,5136 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5146:	ff852583          	lw	a1,-8(a0)
    514a:	6390                	ld	a2,0(a5)
    514c:	02059813          	slli	a6,a1,0x20
    5150:	01c85713          	srli	a4,a6,0x1c
    5154:	9736                	add	a4,a4,a3
    5156:	fae60de3          	beq	a2,a4,5110 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    515a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    515e:	4790                	lw	a2,8(a5)
    5160:	02061593          	slli	a1,a2,0x20
    5164:	01c5d713          	srli	a4,a1,0x1c
    5168:	973e                	add	a4,a4,a5
    516a:	fae68ae3          	beq	a3,a4,511e <free+0x22>
    p->s.ptr = bp->s.ptr;
    516e:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5170:	00004717          	auipc	a4,0x4
    5174:	30f73823          	sd	a5,784(a4) # 9480 <freep>
}
    5178:	6422                	ld	s0,8(sp)
    517a:	0141                	addi	sp,sp,16
    517c:	8082                	ret

000000000000517e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    517e:	7139                	addi	sp,sp,-64
    5180:	fc06                	sd	ra,56(sp)
    5182:	f822                	sd	s0,48(sp)
    5184:	f426                	sd	s1,40(sp)
    5186:	ec4e                	sd	s3,24(sp)
    5188:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    518a:	02051493          	slli	s1,a0,0x20
    518e:	9081                	srli	s1,s1,0x20
    5190:	04bd                	addi	s1,s1,15
    5192:	8091                	srli	s1,s1,0x4
    5194:	0014899b          	addiw	s3,s1,1
    5198:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    519a:	00004517          	auipc	a0,0x4
    519e:	2e653503          	ld	a0,742(a0) # 9480 <freep>
    51a2:	c915                	beqz	a0,51d6 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    51a4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    51a6:	4798                	lw	a4,8(a5)
    51a8:	08977a63          	bgeu	a4,s1,523c <malloc+0xbe>
    51ac:	f04a                	sd	s2,32(sp)
    51ae:	e852                	sd	s4,16(sp)
    51b0:	e456                	sd	s5,8(sp)
    51b2:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    51b4:	8a4e                	mv	s4,s3
    51b6:	0009871b          	sext.w	a4,s3
    51ba:	6685                	lui	a3,0x1
    51bc:	00d77363          	bgeu	a4,a3,51c2 <malloc+0x44>
    51c0:	6a05                	lui	s4,0x1
    51c2:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    51c6:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    51ca:	00004917          	auipc	s2,0x4
    51ce:	2b690913          	addi	s2,s2,694 # 9480 <freep>
  if(p == SBRK_ERROR)
    51d2:	5afd                	li	s5,-1
    51d4:	a081                	j	5214 <malloc+0x96>
    51d6:	f04a                	sd	s2,32(sp)
    51d8:	e852                	sd	s4,16(sp)
    51da:	e456                	sd	s5,8(sp)
    51dc:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    51de:	0000b797          	auipc	a5,0xb
    51e2:	aca78793          	addi	a5,a5,-1334 # fca8 <base>
    51e6:	00004717          	auipc	a4,0x4
    51ea:	28f73d23          	sd	a5,666(a4) # 9480 <freep>
    51ee:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    51f0:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    51f4:	b7c1                	j	51b4 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    51f6:	6398                	ld	a4,0(a5)
    51f8:	e118                	sd	a4,0(a0)
    51fa:	a8a9                	j	5254 <malloc+0xd6>
  hp->s.size = nu;
    51fc:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5200:	0541                	addi	a0,a0,16
    5202:	efbff0ef          	jal	50fc <free>
  return freep;
    5206:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    520a:	c12d                	beqz	a0,526c <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    520c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    520e:	4798                	lw	a4,8(a5)
    5210:	02977263          	bgeu	a4,s1,5234 <malloc+0xb6>
    if(p == freep)
    5214:	00093703          	ld	a4,0(s2)
    5218:	853e                	mv	a0,a5
    521a:	fef719e3          	bne	a4,a5,520c <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    521e:	8552                	mv	a0,s4
    5220:	a33ff0ef          	jal	4c52 <sbrk>
  if(p == SBRK_ERROR)
    5224:	fd551ce3          	bne	a0,s5,51fc <malloc+0x7e>
        return 0;
    5228:	4501                	li	a0,0
    522a:	7902                	ld	s2,32(sp)
    522c:	6a42                	ld	s4,16(sp)
    522e:	6aa2                	ld	s5,8(sp)
    5230:	6b02                	ld	s6,0(sp)
    5232:	a03d                	j	5260 <malloc+0xe2>
    5234:	7902                	ld	s2,32(sp)
    5236:	6a42                	ld	s4,16(sp)
    5238:	6aa2                	ld	s5,8(sp)
    523a:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    523c:	fae48de3          	beq	s1,a4,51f6 <malloc+0x78>
        p->s.size -= nunits;
    5240:	4137073b          	subw	a4,a4,s3
    5244:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5246:	02071693          	slli	a3,a4,0x20
    524a:	01c6d713          	srli	a4,a3,0x1c
    524e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5250:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5254:	00004717          	auipc	a4,0x4
    5258:	22a73623          	sd	a0,556(a4) # 9480 <freep>
      return (void*)(p + 1);
    525c:	01078513          	addi	a0,a5,16
  }
}
    5260:	70e2                	ld	ra,56(sp)
    5262:	7442                	ld	s0,48(sp)
    5264:	74a2                	ld	s1,40(sp)
    5266:	69e2                	ld	s3,24(sp)
    5268:	6121                	addi	sp,sp,64
    526a:	8082                	ret
    526c:	7902                	ld	s2,32(sp)
    526e:	6a42                	ld	s4,16(sp)
    5270:	6aa2                	ld	s5,8(sp)
    5272:	6b02                	ld	s6,0(sp)
    5274:	b7f5                	j	5260 <malloc+0xe2>
