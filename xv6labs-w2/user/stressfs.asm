...
main(int argc, char *argv[])
{
  ...
  1a:	97a78793          	addi	a5,a5,-1670 # 990 <malloc+0x12a>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	93450513          	addi	a0,a0,-1740 # 960 <malloc+0xfa>
  34:	77e000ef          	jal	7b2 <printf>
  ...
  60:	91c50513          	addi	a0,a0,-1764 # 978 <malloc+0x112>
  64:	74e000ef          	jal	7b2 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	8ee50513          	addi	a0,a0,-1810 # 988 <malloc+0x122>
  a2:	710000ef          	jal	7b2 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 45e:	54e50513          	addi	a0,a0,1358 # 9a8 <digits>
 462:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fc:	2b0b8b93          	addi	s7,s7,688 # 9a8 <digits>
 ...
 75e:	24690913          	addi	s2,s2,582 # 9a0 <malloc+0x13a>
        for(; *s; s++)
